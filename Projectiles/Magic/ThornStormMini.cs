...
{
    internal class ThornStormMini : ModProjectile
    {
        ...
        public override string Texture => "TheTesseractMod/Projectiles/Magic/ThornStormMainHead";
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            for (int i = 0; i < trailPositions.Count; i++)
            {
                ...
                Main.EntitySpriteDraw(texture.Value, drawPos, null, Projectile.GetAlpha(Color.White * alpha), rotation, drawOrigin, .52f, SpriteEffects.None, 0f);
            }
            ...
            Main.EntitySpriteDraw(mainTexture, headDrawPos, null, Projectile.GetAlpha(Color.White), Projectile.rotation, drawOrigin, .52f, SpriteEffects.None, 0f);
