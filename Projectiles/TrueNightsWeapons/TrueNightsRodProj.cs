...
{
    internal class TrueNightsRodProj : ModProjectile
    {
        public override string Texture => "TheTesseractMod/Projectiles/NightsWeapons/NightsRodBeam";
        private float speed;
        ...
        public override void AI()
        {
            ...
            else
            {
                ...
                for (int i = 0; i < 3; i++)
                {
                    ...
                    int dust = Dust.NewDust(Projectile.position, Projectile.width, Projectile.height, DustID.CursedTorch, 0, 0, 150, default(Color), 1.3f);
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            Main.EntitySpriteDraw(texture, Projectile.Center - Main.screenPosition + new Vector2(0f, Projectile.gfxOffY), new Microsoft.Xna.Framework.Rectangle?(sourceRectangle),
                Projectile.GetAlpha(new Color(182 / 255f, 255 / 255f, 36 / 255f)),
        ...
        public override void OnHitNPC(NPC target, NPC.HitInfo hit, int damageDone)
        {
            ...
            if (!hasHit)
            {
                ...
                Projectile.timeLeft = Projectile.timeLeft + 60;
            }
            hasHit = true;
