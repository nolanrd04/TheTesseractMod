...
{
    internal class DarkEtherealStar : ModProjectile
    {
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            Main.EntitySpriteDraw(Texture.Value,
                ...
                new Color(223, 194, 255, 0) * (1f - Projectile.alpha / 255f), rotationFactor, Texture.Size() * 0.5f, scalingFactor * 0.25f, SpriteEffects.None, 0f);

            return false;
        }
        public override void AI()
        {
            Lighting.AddLight(Projectile.position, new Vector3(223/255f, 194/255f, 255/255f));
            Dust.NewDust(Projectile.position, Projectile.width/2, Projectile.height/2, 27, Projectile.velocity.X*0.9f, Projectile.velocity.Y * 0.9f, 150, default(Color), 1f);
            Projectile.ai[0]++;
