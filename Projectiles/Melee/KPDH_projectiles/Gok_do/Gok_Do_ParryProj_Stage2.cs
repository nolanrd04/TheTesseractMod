...
{
    internal class Gok_Do_ParryProj_Stage2 : ModProjectile
    {
        public override string Texture => "TheTesseractMod/Projectiles/Melee/KPDH_projectiles/Gok_do/Gok_Do_Proj_Stage2";
        ...
        public override void AI()
        {
            ...
            {
                Projectile.NewProjectile(Projectile.InheritSource(Projectile), Projectile.Center, new Vector2(10f, 0).RotatedByRandom(2 * Math.PI), ModContent.ProjectileType<Sain_geom_star_2>(), Projectile.damage, 0f);
            }
            ...
            for (int i = 0; i < Main.maxProjectiles; i++)
            {
                ...
                if (other.active && other.hostile)
                {
                    ...
                    if (Projectile.Hitbox.Intersects(other.Hitbox))
                    {
                        if (other.damage > 280)
                        {
                            other.damage = (int)(other.damage * 0.7f);
