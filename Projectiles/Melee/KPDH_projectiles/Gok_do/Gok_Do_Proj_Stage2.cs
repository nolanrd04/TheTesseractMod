...
{
    internal class Gok_Do_Proj_Stage2 : ModProjectile
    {
        ...
        public override bool PreAI()
        {
            ...
            if (Main.rand.Next(50) == 0)
            {
                ...
                Projectile.NewProjectile(Projectile.InheritSource(Projectile), Projectile.Center, vel, ModContent.ProjectileType<Gok_Do_Star_Stage2>(), Projectile.damage / 2, 0);
            }
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            {
                Dust.NewDust(Projectile.Center, 0, 0, ModContent.DustType<SharpRadialGlowDust>(), 0, 0, 0, new Color(127, 68, 252, 0), Main.rand.NextFloat(.4f) + .4f);
            }
