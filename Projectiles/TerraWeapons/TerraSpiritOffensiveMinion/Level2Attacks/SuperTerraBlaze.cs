...
namespace TheTesseractMod.Projectiles.TerraWeapons.TerraSpiritOffensiveMinion.Level2Attacks
{
    internal class SuperTerraBlaze : ModProjectile
    {
        const int frameSpeed = 25;
        int projectileFrameCounter;
        float scaleVal_1 = 1f;
        float scaleVal_2 = -1;
        const int textureHeight = 42;
        ...
        public override void AI()
        {
            ...
            {
                Dust topDust = Dust.NewDustPerfect(topSpawnPosition, DustID.UltraBrightTorch, Projectile.velocity, 0, default(Color), 1.5f);
                topDust.noGravity = true;
            }
            ...
            {
                Dust bottomDust = Dust.NewDustPerfect(bottomSpawnPosition, DustID.UltraBrightTorch, Projectile.velocity, 0, default(Color), 1.5f);
                bottomDust.noGravity = true;
            }
            ...
            if (Main.rand.Next(3) == 0)
            {
                int greenDust = Dust.NewDust(Projectile.position, Projectile.width, Projectile.height, DustID.UltraBrightTorch, Projectile.velocity.X, Projectile.velocity.Y, 120, default(Color), 1f);
            ...
            if (GlobalProjectileFunctions.IsTargetValid(target, Projectile.Center, 500f))
            {
