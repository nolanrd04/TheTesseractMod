...
namespace TheTesseractMod.Projectiles.HallowedWeapons
{
    internal class GoldenKnightProj : ModProjectile
    {
        ...
        private bool CheckActive(Player owner)
        {
            ...
            {
                owner.ClearBuff(ModContent.BuffType<GoldenKnightMinionBuff>());

                return false;
            }

            if (owner.HasBuff(ModContent.BuffType<GoldenKnightMinionBuff>()))
            {
        ...
        {
            Texture2D wingTexture = ModContent.Request<Texture2D>("TheTesseractMod/Projectiles/HallowedWeapons/GoldenKnightProjWings").Value;
