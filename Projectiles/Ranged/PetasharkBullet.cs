...
{
    internal class PetasharkBullet : ModProjectile
    {
        public override string Texture => "TheTesseractMod/Projectiles/TrueExcaliburWeapons/GigasharkBullet";
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            Main.EntitySpriteDraw(texture, Projectile.Center - Main.screenPosition + new Vector2(0f, Projectile.gfxOffY), new Microsoft.Xna.Framework.Rectangle?(sourceRectangle),
                new Color(15 / 255f, 247 / 255f, 215 / 255f, 0) * (1f - Projectile.alpha / 255f),
