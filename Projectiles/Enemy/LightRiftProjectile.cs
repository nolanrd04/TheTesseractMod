...
{
    internal class LightRiftProjectile : ModProjectile
    {
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            Main.EntitySpriteDraw(glowTexture.Value,
                ...
                color, rotationFactor, glowTexture.Size() * 0.5f, scalingFactor * 0.25f, SpriteEffects.None, 0f);
        ...
        {
            return new Color(255, 252, 153, 0) * (1f - Projectile.alpha / 255f);
        }
    }
}