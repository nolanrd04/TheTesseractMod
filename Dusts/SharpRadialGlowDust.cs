...
{
    internal class SharpRadialGlowDust : ModDust
    {
        public override string Texture => "TheTesseractMod/Textures/SharpCenterOutwardRadialGlow";
        public override void OnSpawn(Dust dust)
        {
            dust.noGravity = true;
            dust.scale = dust.scale * 0.08f;
            dust.frame = new Rectangle(0, 0, 433, 433);
        }
        public override bool Update(Dust dust)
        {
            ...
            dust.position += dust.velocity *= 0.94f;
