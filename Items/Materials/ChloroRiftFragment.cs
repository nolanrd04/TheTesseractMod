...
{
    internal class ChloroRiftFragment : ModItem
    {
        ...
        {
            Lighting.AddLight(Item.Center, Color.Lime.ToVector3());
        }
        ...
        public override bool PreDrawInWorld(SpriteBatch spriteBatch, Color lightColor, Color alphaColor, ref float rotation, ref float scale, int whoAmI)
        {
            ...
            spriteBatch.Draw(glowTexture,
                ...
                Color.Lime, rotation, glowTexture.Size() * 0.5f, (scale) * scalingFactor, SpriteEffects.None, 0f);

            UpdateScalingFactor();
            //draw texture
            Asset<Texture2D> itemTexture = ModContent.Request<Texture2D>("TheTesseractMod/Items/Materials/ChloroRiftFragment");
            spriteBatch.Draw(itemTexture.Value,
                new Vector2(Item.position.X - Main.screenPosition.X + Item.width * 0.5f, Item.position.Y - Main.screenPosition.Y + Item.height * 0.5f),
                new Rectangle(0, 0, itemTexture.Value.Width, itemTexture.Value.Height),
                Color.White, rotation, itemTexture.Value.Size() * 0.5f, (scale * 1.5f) * scalingFactor, SpriteEffects.None, 0f);
        ...
        {
            UpdateScalingFactor();
            Asset<Texture2D> texture = ModContent.Request<Texture2D>("TheTesseractMod/Items/Materials/ChloroRiftFragment");
            spriteBatch.Draw(texture.Value, position, null,
               Color.White, 0, texture.Size() / 2, (scale * 1.5f) * scalingFactor, SpriteEffects.None, 0f);
