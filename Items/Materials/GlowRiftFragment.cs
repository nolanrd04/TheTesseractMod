...
{
    internal class GlowRiftFragment : ModItem
    {
        ...
        public override bool PreDrawInWorld(SpriteBatch spriteBatch, Color lightColor, Color alphaColor, ref float rotation, ref float scale, int whoAmI)
        {
            ...
            spriteBatch.Draw(glowTexture,
                ...
                Color.Blue, rotation, glowTexture.Size() * 0.5f, scale * scalingFactor, SpriteEffects.None, 0f);

            UpdateScalingFactor();
            //draw texture
            Asset<Texture2D> itemTexture = ModContent.Request<Texture2D>("TheTesseractMod/Items/Materials/GlowRiftFragment");
        ...
        {
            UpdateScalingFactor();
            Asset<Texture2D> texture = ModContent.Request<Texture2D>("TheTesseractMod/Items/Materials/GlowRiftFragment");
