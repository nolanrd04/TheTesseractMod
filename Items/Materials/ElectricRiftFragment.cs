...
{
    internal class ElectricRiftFragment : ModItem
    {
        ...
        public override bool PreDrawInWorld(SpriteBatch spriteBatch, Color lightColor, Color alphaColor, ref float rotation, ref float scale, int whoAmI)
        {
            UpdateScalingFactor();
            //draw texture
            Asset<Texture2D> itemTexture = ModContent.Request<Texture2D>("TheTesseractMod/Items/Materials/ElectricRiftFragment");
        ...
        {
            UpdateScalingFactor();
            Asset<Texture2D> texture = ModContent.Request<Texture2D>("TheTesseractMod/Items/Materials/ElectricRiftFragment");
            spriteBatch.Draw(texture.Value, position, null,
               Color.White, 0, texture.Size() / 2, (scale * 1.8f) * scalingFactor, SpriteEffects.None, 0f);
