...
{
    internal class LightRiftFragment : ModItem
    {
        ...
        {
            Lighting.AddLight(Item.Center, Color.LightYellow.ToVector3());
        }
        public override bool PreDrawInWorld(SpriteBatch spriteBatch, Color lightColor, Color alphaColor, ref float rotation, ref float scale, int whoAmI)
        {
            UpdateScalingFactor();
            //draw texture
            Asset<Texture2D> itemTexture = ModContent.Request<Texture2D>("TheTesseractMod/Items/Materials/LightRiftFragment");
        ...
        {
            UpdateScalingFactor();
            Asset<Texture2D> texture = ModContent.Request<Texture2D>("TheTesseractMod/Items/Materials/LightRiftFragment");
