...
{
    internal class Tesseract8 : ModItem
    {
        ...
        public override void ModifyTooltips(List<TooltipLine> tooltips)
        {
            ...
            foreach (TooltipLine line in tooltips)
            {
                ...
                if (line.Mod == "Terraria" && line.Text.Contains("Stardust Relocator"))
                {
                    float fade = (Main.GameUpdateCount % 60) / 60f;
                    int index = (int)((Main.GameUpdateCount / 60) % numColors);
                    int nextIndex = (index + 1) % numColors;
                    ...
                    line.Text = line.Text.Replace("Stardust Relocator", $"[c/{rgbValue}:Stardust Relocator]");
                }
                ...
                if (line.Mod == "Terraria" && line.Text.Contains("chaos debuff"))
                {
                    float fade = (Main.GameUpdateCount % 60) / 60f;
                    int index = (int)((Main.GameUpdateCount / 60) % numColors);
                    int nextIndex = (index + 1) % numColors;
                    ...
                    line.Text = line.Text.Replace("chaos debuff", $"[c/ff0000:chaos debuff]");
                }
            }
        }
        ...
        public override void AddRecipes()
        {
            ...
            recipe.AddIngredient(ModContent.ItemType<TemporalBar>(), 15);
            recipe.AddIngredient(ModContent.ItemType<Tesseract7>(), 1);
