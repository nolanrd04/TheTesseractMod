...
{
    public class ApexN31OLD
    { /* : ModItem // If you are reading this, I was not aware we should use Main.rand for randoms. Therefore a lot of the code I wrote creates new instances of randoms.
    {
    ...
    /*66% chance not to consume ammo
			Shoots 2 streams of zenith energy bolts that
			explode on impact. Also shoots a random vanilla
			bullet, and randomly shoots homing rockets.
			RIGHT-CLICK ATTACK: For every 15 enemies you hit, 1 rocket will be loaded into the chamber for
			a maximum of 10 rockets. Right click to launch the rockets in a rapid barrage. 1 rocket loaded 
			will play the mana recharge sfx. Max rockets loaded will play the mana crystal consume sfx.
			Right click to overclock and to release the barage.*/
}
