...
namespace TheTesseractMod.Items.Placeable.Furniture
{
	public class TemporalGuardianRelic : ModItem
	{
		public override void SetDefaults() {
			...
			Item.DefaultToPlaceableTile(ModContent.TileType<Tiles.Furniture.TemporalGuardianRelic>(), 0);
