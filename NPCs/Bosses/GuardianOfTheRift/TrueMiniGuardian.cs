...
{
    public class TrueMiniGuardian : ModNPC
    {
        ...
        public override void SetDefaults()
        {
            ...
            NPC.noTileCollide = true; // No tile collision
        ...
        public override void AI()
        {
            ...
            {
                Projectile.NewProjectile(NPC.GetSource_FromAI(), NPC.Center, Vector2.Zero, ModContent.ProjectileType<LightRiftProjectile>(), 0, 0f);
                NPC.ai[0] = 0; // Reset timer to prevent multiple projectiles from spawning
            }
            if (NPC.ai[0] == 0)
            {
                SoundEngine.PlaySound(SoundID.Item8, NPC.Center); // Play spawn sound
            }
