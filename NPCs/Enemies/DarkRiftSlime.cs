...
{
    internal class DarkRiftSlime :ModNPC
    {
        private int timer = 0;
        ...
        {
            return (SpawnCondition.OverworldNight.Chance * NPC.downedMoonlord.ToInt()) * 0.17f;
        }
        ...
        public override void AI()
        {
            ...
            if (timer % 5 == 0)
            {
                Dust.NewDust(NPC.position, NPC.width, NPC.height, 27, NPC.velocity.X, NPC.velocity.Y, 150, default(Color), 1.5f);
            }
            if (timer % 240 == 0 && distance > 300)
            {
                if (Main.netMode != NetmodeID.MultiplayerClient)
                {
                    ...
                    Projectile.NewProjectile(NPC.InheritSource(NPC), NPC.Center, new Vector2(4f, 4f).RotatedBy(rotation), ModContent.ProjectileType<DarkRiftProjectile>(), 50, 10);
        ...
        {
            Color color = new Color(182, 130, 245);
            ...
            spriteBatch.Draw(glowTexture.Value,
                ...
                color, 0, glowTexture.Size() * 0.5f, 1.75f, SpriteEffects.None, 0f);
        ...
        public override void SetBestiary(BestiaryDatabase database, BestiaryEntry bestiaryEntry)
        {
            ...
            bestiaryEntry.Info.AddRange(new IBestiaryInfoElement[] {
				...
				new FlavorTextBestiaryInfoElement("Darkness has taken the form of something... bouncy?"),
            });
        }

        public override void ModifyNPCLoot(NPCLoot npcLoot)
        {
            npcLoot.Add(ItemDropRule.Common(ModContent.ItemType<DarkRiftFragment>(), 3, 1, 3));
        }
    }
}
