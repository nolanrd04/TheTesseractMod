...
namespace TheTesseractMod.Tiles.Furniture
{
	...
	public class TemporalGuardianRelic : ModTile
	{
		...
		public virtual string RelicTextureName => "TheTesseractMod/Tiles/Furniture/TemporalGuardianRelic";

		// All relics use the same pedestal texture, this one is copied from vanilla
		public override string Texture => "TheTesseractMod/Tiles/Furniture/RelicPedestal";
